...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"milky_ui_rnmac"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit milky_ui_rnmac" action:@selector(terminate:) keyEquivalent:@"q"];
